...
C_wmma_accumulatorktileAll = model.NewIntVar(1, 1024, 'C_wmma_accumulatorktileAll')
C_wmma_accumulator_k_outer = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_outer')
C_wmma_accumulator_k_inner = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner')
...
C_wmma_accumulatork_innertileAll = model.NewIntVar(1, 1024, 'C_wmma_accumulatork_innertileAll')
C_wmma_accumulator_k_inner_outer = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_outer')
C_wmma_accumulator_k_inner_inner = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_inner')
...
C_wmma_accumulatork_inner_innertileAll = model.NewIntVar(1, 1024, 'C_wmma_accumulatork_inner_innertileAll')
C_wmma_accumulator_k_inner_inner_outer = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_inner_outer')
C_wmma_accumulator_k_inner_inner_inner = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_inner_inner')
...
C_wmma_accumulator_k_inner_inner_inner_outer = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_inner_inner_outer')
C_wmma_accumulator_k_inner_inner_inner_inner = model.NewIntVar(1, 1024, 'C_wmma_accumulator_k_inner_inner_inner_inner')
...
A_shared_wmma_matrix_b_ax1 = model.NewIntVar(1, 1024, 'A_shared_wmma_matrix_b_ax1')
...
A_shared_wmma_matrix_b_ax1_outer = model.NewIntVar(1, 1024, 'A_shared_wmma_matrix_b_ax1_outer')
A_shared_wmma_matrix_b_ax1_inner = model.NewIntVar(1, 1024, 'A_shared_wmma_matrix_b_ax1_inner')
...
B_shared_wmma_matrix_a_ax1 = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_a_ax1')
...
B_shared_wmma_matrix_a_ax1_outer = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_a_ax1_outer')
B_shared_wmma_matrix_a_ax1_inner = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_a_ax1_inner')
B_shared_ax0 = model.NewIntVar(1, 512, 'B_shared_ax0')
B_shared_tmp_ax0 = model.NewIntVar(1, 512, 'B_shared_tmp_ax0')
B_shared_ax1 = model.NewIntVar(1, 1024, 'B_shared_ax1')
...
model.AddMultiplicationEquality(1024, [C_wmma_accumulator_k_outer, C_wmma_accumulator_k_inner])

...
n_c_f_d_f_p_f_q_f = s[output].fuse(n, c, d, p, q, )
n_c_f_d_f_p_f_q_f_o, n_c_f_d_f_p_f_q_f_i = s[output].split(n_c_f_d_f_p_f_q_f, factor = 1)
s[output].vectorize(n_c_f_d_f_p_f_q_f_i)
n_c_f_d_f_p_f_q_f_o_o, n_c_f_d_f_p_f_q_f_o_i = s[output].split(n_c_f_d_f_p_f_q_f_o, factor = 1)
s[output].bind(n_c_f_d_f_p_f_q_f_o_i, te.thread_axis("threadIdx.x"))
n_c_f_d_f_p_f_q_f_o_o_o, n_c_f_d_f_p_f_q_f_o_o_i = s[output].split(n_c_f_d_f_p_f_q_f_o_o, factor = 1)
s[output].bind(n_c_f_d_f_p_f_q_f_o_o_i, te.thread_axis("threadIdx.y"))
s[output].bind(n_c_f_d_f_p_f_q_f_o_o_o, te.thread_axis("blockIdx.x"))

...
dense_globali_ctileAll = model.NewIntVar(1, 64, 'dense_globali_ctileAll')
...
dense_globalj_ctileAll = model.NewIntVar(1, 64, 'dense_globalj_ctileAll')
...
dense_globalktileAll = model.NewIntVar(1, 64, 'dense_globalktileAll')
...
dense_globali_c_innertileAll = model.NewIntVar(1, 64, 'dense_globali_c_innertileAll')
dense_global_i_c_inner_outer = model.NewIntVar(1, 64, 'dense_global_i_c_inner_outer')
dense_global_i_c_inner_inner = model.NewIntVar(1, 64, 'dense_global_i_c_inner_inner')
dense_globalj_c_innertileAll = model.NewIntVar(1, 64, 'dense_globalj_c_innertileAll')
dense_global_j_c_inner_outer = model.NewIntVar(1, 64, 'dense_global_j_c_inner_outer')
dense_global_j_c_inner_inner = model.NewIntVar(1, 64, 'dense_global_j_c_inner_inner')
dense_globalk_innertileAll = model.NewIntVar(1, 64, 'dense_globalk_innertileAll')
dense_global_k_inner_outer = model.NewIntVar(1, 64, 'dense_global_k_inner_outer')
dense_global_k_inner_inner = model.NewIntVar(1, 64, 'dense_global_k_inner_inner')
dense_globali_c_inner_innertileAll = model.NewIntVar(1, 64, 'dense_globali_c_inner_innertileAll')
dense_global_i_c_inner_inner_outer = model.NewIntVar(1, 64, 'dense_global_i_c_inner_inner_outer')
dense_global_i_c_inner_inner_inner = model.NewIntVar(1, 64, 'dense_global_i_c_inner_inner_inner')
dense_globalj_c_inner_innertileAll = model.NewIntVar(1, 64, 'dense_globalj_c_inner_innertileAll')
dense_global_j_c_inner_inner_outer = model.NewIntVar(1, 64, 'dense_global_j_c_inner_inner_outer')
dense_global_j_c_inner_inner_inner = model.NewIntVar(1, 64, 'dense_global_j_c_inner_inner_inner')
dense_globalk_inner_innertileAll = model.NewIntVar(1, 64, 'dense_globalk_inner_innertileAll')
dense_global_k_inner_inner_outer = model.NewIntVar(1, 64, 'dense_global_k_inner_inner_outer')
dense_global_k_inner_inner_inner = model.NewIntVar(1, 64, 'dense_global_k_inner_inner_inner')
...
model.Add(dense_global_i_c_outer == dense_globali_ctileAll)
model.AddMultiplicationEquality(dense_global_j_c, [dense_global_j_c_outer, dense_global_j_c_inner])
model.Add(dense_global_j_c_outer == dense_globalj_ctileAll)
model.AddMultiplicationEquality(64, [dense_global_k_outer, dense_global_k_inner])
model.Add(dense_global_k_outer == dense_globalktileAll)
model.AddMultiplicationEquality(dense_global_i_c_inner, [dense_global_i_c_inner_outer, dense_global_i_c_inner_inner])
model.Add(dense_global_i_c_inner_outer == dense_globali_c_innertileAll)
model.AddMultiplicationEquality(dense_global_j_c_inner, [dense_global_j_c_inner_outer, dense_global_j_c_inner_inner])
model.Add(dense_global_j_c_inner_outer == dense_globalj_c_innertileAll)
model.AddMultiplicationEquality(dense_global_k_inner, [dense_global_k_inner_outer, dense_global_k_inner_inner])
model.Add(dense_global_k_inner_outer == dense_globalk_innertileAll)
model.AddMultiplicationEquality(dense_global_i_c_inner_inner, [dense_global_i_c_inner_inner_outer, dense_global_i_c_inner_inner_inner])
model.Add(dense_global_i_c_inner_inner_outer == dense_globali_c_inner_innertileAll)
model.AddMultiplicationEquality(dense_global_j_c_inner_inner, [dense_global_j_c_inner_inner_outer, dense_global_j_c_inner_inner_inner])
model.Add(dense_global_j_c_inner_inner_outer == dense_globalj_c_inner_innertileAll)
model.AddMultiplicationEquality(dense_global_k_inner_inner, [dense_global_k_inner_inner_outer, dense_global_k_inner_inner_inner])
model.Add(dense_global_k_inner_inner_outer == dense_globalk_inner_innertileAll)

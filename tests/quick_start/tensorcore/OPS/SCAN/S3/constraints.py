...
dense_i_outer = model.NewIntVar(1, 256, 'dense_i_outer')
dense_i_inner = model.NewIntVar(1, 256, 'dense_i_inner')
dense_j_outer = model.NewIntVar(1, 1024, 'dense_j_outer')
dense_j_inner = model.NewIntVar(1, 1024, 'dense_j_inner')
densei_innertileSpatial = model.NewIntVar(1, 256, 'densei_innertileSpatial')
dense_i_inner_outer = model.NewIntVar(1, 256, 'dense_i_inner_outer')
dense_i_inner_inner = model.NewIntVar(1, 256, 'dense_i_inner_inner')
densej_innertileSpatial = model.NewIntVar(1, 1024, 'densej_innertileSpatial')
dense_j_inner_outer = model.NewIntVar(1, 1024, 'dense_j_inner_outer')
dense_j_inner_inner = model.NewIntVar(1, 1024, 'dense_j_inner_inner')
...
densei_inner_innertileSpatial = model.NewIntVar(1, 256, 'densei_inner_innertileSpatial')
dense_i_inner_inner_outer = model.NewIntVar(1, 256, 'dense_i_inner_inner_outer')
dense_i_inner_inner_inner = model.NewIntVar(1, 256, 'dense_i_inner_inner_inner')
densej_inner_innertileSpatial = model.NewIntVar(1, 1024, 'densej_inner_innertileSpatial')
dense_j_inner_inner_outer = model.NewIntVar(1, 1024, 'dense_j_inner_inner_outer')
dense_j_inner_inner_inner = model.NewIntVar(1, 1024, 'dense_j_inner_inner_inner')
...
densei_inner_inner_innertileSpatial = model.NewIntVar(1, 256, 'densei_inner_inner_innertileSpatial')
dense_i_inner_inner_inner_outer = model.NewIntVar(1, 256, 'dense_i_inner_inner_inner_outer')
dense_i_inner_inner_inner_inner = model.NewIntVar(1, 256, 'dense_i_inner_inner_inner_inner')
densej_inner_inner_innertileSpatial = model.NewIntVar(1, 1024, 'densej_inner_inner_innertileSpatial')
dense_j_inner_inner_inner_outer = model.NewIntVar(1, 1024, 'dense_j_inner_inner_inner_outer')
dense_j_inner_inner_inner_inner = model.NewIntVar(1, 1024, 'dense_j_inner_inner_inner_inner')
...
densei_inner_inner_inner_innertileSpatial = model.NewIntVar(1, 256, 'densei_inner_inner_inner_innertileSpatial')
dense_i_inner_inner_inner_inner_outer = model.NewIntVar(1, 256, 'dense_i_inner_inner_inner_inner_outer')
dense_i_inner_inner_inner_inner_inner = model.NewIntVar(1, 256, 'dense_i_inner_inner_inner_inner_inner')
densej_inner_inner_inner_innertileSpatial = model.NewIntVar(1, 1024, 'densej_inner_inner_inner_innertileSpatial')
dense_j_inner_inner_inner_inner_outer = model.NewIntVar(1, 1024, 'dense_j_inner_inner_inner_inner_outer')
dense_j_inner_inner_inner_inner_inner = model.NewIntVar(1, 1024, 'dense_j_inner_inner_inner_inner_inner')
...
dense_wmma_accumulator_shared_ax0 = model.NewIntVar(1, 256, 'dense_wmma_accumulator_shared_ax0')
...
dense_wmma_accumulator_shared_ax1 = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_shared_ax1')
...
dense_wmma_accumulator_sharedax0tileSpatial = model.NewIntVar(1, 256, 'dense_wmma_accumulator_sharedax0tileSpatial')
dense_wmma_accumulator_shared_ax0_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_shared_ax0_outer')
dense_wmma_accumulator_shared_ax0_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_shared_ax0_inner')
dense_wmma_accumulator_sharedax1tileSpatial = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_sharedax1tileSpatial')
dense_wmma_accumulator_shared_ax1_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_shared_ax1_outer')
dense_wmma_accumulator_shared_ax1_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_shared_ax1_inner')
...
dense_wmma_accumulator_shared_ax0_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_shared_ax0_inner_outer')
dense_wmma_accumulator_shared_ax0_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_shared_ax0_inner_inner')
dense_wmma_accumulator_shared_ax1_inner_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_shared_ax1_inner_outer')
dense_wmma_accumulator_shared_ax1_inner_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_shared_ax1_inner_inner')
dense_wmma_accumulator_i_c = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c')
...
dense_wmma_accumulator_j_c = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c')
dense_wmma_accumulatori_ctileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatori_ctileAll')
dense_wmma_accumulator_i_c_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_outer')
dense_wmma_accumulator_i_c_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner')
dense_wmma_accumulatorj_ctileAll = model.NewIntVar(1, 1024, 'dense_wmma_accumulatorj_ctileAll')
dense_wmma_accumulator_j_c_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_outer')
dense_wmma_accumulator_j_c_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner')
dense_wmma_accumulatorktileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatorktileAll')
dense_wmma_accumulator_k_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_outer')
dense_wmma_accumulator_k_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner')
dense_wmma_accumulatori_c_innertileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatori_c_innertileAll')
dense_wmma_accumulator_i_c_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_outer')
dense_wmma_accumulator_i_c_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_inner')
dense_wmma_accumulatorj_c_innertileAll = model.NewIntVar(1, 1024, 'dense_wmma_accumulatorj_c_innertileAll')
dense_wmma_accumulator_j_c_inner_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_outer')
dense_wmma_accumulator_j_c_inner_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_inner')
dense_wmma_accumulatork_innertileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatork_innertileAll')
dense_wmma_accumulator_k_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_outer')
dense_wmma_accumulator_k_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_inner')
dense_wmma_accumulatori_c_inner_innertileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatori_c_inner_innertileAll')
dense_wmma_accumulator_i_c_inner_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_inner_outer')
dense_wmma_accumulator_i_c_inner_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_inner_inner')
dense_wmma_accumulatorj_c_inner_innertileAll = model.NewIntVar(1, 1024, 'dense_wmma_accumulatorj_c_inner_innertileAll')
dense_wmma_accumulator_j_c_inner_inner_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_inner_outer')
dense_wmma_accumulator_j_c_inner_inner_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_inner_inner')
dense_wmma_accumulatork_inner_innertileAll = model.NewIntVar(1, 256, 'dense_wmma_accumulatork_inner_innertileAll')
dense_wmma_accumulator_k_inner_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_inner_outer')
dense_wmma_accumulator_k_inner_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_inner_inner')
dense_wmma_accumulator_i_c_inner_inner_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_inner_inner_outer')
dense_wmma_accumulator_i_c_inner_inner_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_i_c_inner_inner_inner_inner')
dense_wmma_accumulator_j_c_inner_inner_inner_outer = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_inner_inner_outer')
dense_wmma_accumulator_j_c_inner_inner_inner_inner = model.NewIntVar(1, 1024, 'dense_wmma_accumulator_j_c_inner_inner_inner_inner')
dense_wmma_accumulator_k_inner_inner_inner_outer = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_inner_inner_outer')
dense_wmma_accumulator_k_inner_inner_inner_inner = model.NewIntVar(1, 256, 'dense_wmma_accumulator_k_inner_inner_inner_inner')
B_shared_wmma_matrix_b_ax0 = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_b_ax0')
B_shared_wmma_matrix_b_ax0_outer = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_b_ax0_outer')
B_shared_wmma_matrix_b_ax0_inner = model.NewIntVar(1, 1024, 'B_shared_wmma_matrix_b_ax0_inner')
B_shared_wmma_matrix_b_ax1 = model.NewIntVar(1, 256, 'B_shared_wmma_matrix_b_ax1')
B_shared_wmma_matrix_b_ax1_outer = model.NewIntVar(1, 256, 'B_shared_wmma_matrix_b_ax1_outer')
B_shared_wmma_matrix_b_ax1_inner = model.NewIntVar(1, 256, 'B_shared_wmma_matrix_b_ax1_inner')
B_shared_ax0 = model.NewIntVar(1, 1024, 'B_shared_ax0')
B_shared_tmp_ax0 = model.NewIntVar(1, 1024, 'B_shared_tmp_ax0')
...
A_shared_wmma_matrix_a_ax0 = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax0')
...
A_shared_wmma_matrix_a_ax1 = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax1')
A_shared_wmma_matrix_a_ax0_outer = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax0_outer')
A_shared_wmma_matrix_a_ax0_inner = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax0_inner')
A_shared_wmma_matrix_a_ax1_outer = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax1_outer')
A_shared_wmma_matrix_a_ax1_inner = model.NewIntVar(1, 256, 'A_shared_wmma_matrix_a_ax1_inner')
A_shared_ax0 = model.NewIntVar(1, 256, 'A_shared_ax0')
A_shared_tmp_ax0 = model.NewIntVar(1, 256, 'A_shared_tmp_ax0')
...
model.AddMultiplicationEquality(256, [dense_i_outer, dense_i_inner])
model.Add(dense_i_outer == 1)
model.AddMultiplicationEquality(1024, [dense_j_outer, dense_j_inner])
...
model.AddMultiplicationEquality(256, [dense_wmma_accumulator_k_outer, dense_wmma_accumulator_k_inner])

...
dense_j_outer = model.NewIntVar(1, 16, 'dense_j_outer')
dense_j_inner = model.NewIntVar(1, 16, 'dense_j_inner')
...
densej_innertileSpatial = model.NewIntVar(1, 16, 'densej_innertileSpatial')
dense_j_inner_outer = model.NewIntVar(1, 16, 'dense_j_inner_outer')
dense_j_inner_inner = model.NewIntVar(1, 16, 'dense_j_inner_inner')
...
densej_inner_innertileSpatial = model.NewIntVar(1, 16, 'densej_inner_innertileSpatial')
dense_j_inner_inner_outer = model.NewIntVar(1, 16, 'dense_j_inner_inner_outer')
dense_j_inner_inner_inner = model.NewIntVar(1, 16, 'dense_j_inner_inner_inner')
...
densej_inner_inner_innertileSpatial = model.NewIntVar(1, 16, 'densej_inner_inner_innertileSpatial')
dense_j_inner_inner_inner_outer = model.NewIntVar(1, 16, 'dense_j_inner_inner_inner_outer')
dense_j_inner_inner_inner_inner = model.NewIntVar(1, 16, 'dense_j_inner_inner_inner_inner')
...
densej_inner_inner_inner_innertileSpatial = model.NewIntVar(1, 16, 'densej_inner_inner_inner_innertileSpatial')
dense_j_inner_inner_inner_inner_outer = model.NewIntVar(1, 16, 'dense_j_inner_inner_inner_inner_outer')
dense_j_inner_inner_inner_inner_inner = model.NewIntVar(1, 16, 'dense_j_inner_inner_inner_inner_inner')
...
dense_wmma_accumulator_shared_ax1 = model.NewIntVar(1, 16, 'dense_wmma_accumulator_shared_ax1')
...
dense_wmma_accumulator_sharedax1tileSpatial = model.NewIntVar(1, 16, 'dense_wmma_accumulator_sharedax1tileSpatial')
dense_wmma_accumulator_shared_ax1_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_shared_ax1_outer')
dense_wmma_accumulator_shared_ax1_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_shared_ax1_inner')
...
dense_wmma_accumulator_shared_ax1_inner_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_shared_ax1_inner_outer')
dense_wmma_accumulator_shared_ax1_inner_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_shared_ax1_inner_inner')
...
dense_wmma_accumulator_j_c = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c')
...
dense_wmma_accumulatorj_ctileAll = model.NewIntVar(1, 16, 'dense_wmma_accumulatorj_ctileAll')
dense_wmma_accumulator_j_c_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_outer')
dense_wmma_accumulator_j_c_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner')
...
dense_wmma_accumulatorj_c_innertileAll = model.NewIntVar(1, 16, 'dense_wmma_accumulatorj_c_innertileAll')
dense_wmma_accumulator_j_c_inner_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_outer')
dense_wmma_accumulator_j_c_inner_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_inner')
...
dense_wmma_accumulatorj_c_inner_innertileAll = model.NewIntVar(1, 16, 'dense_wmma_accumulatorj_c_inner_innertileAll')
dense_wmma_accumulator_j_c_inner_inner_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_inner_outer')
dense_wmma_accumulator_j_c_inner_inner_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_inner_inner')
...
dense_wmma_accumulator_j_c_inner_inner_inner_outer = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_inner_inner_outer')
dense_wmma_accumulator_j_c_inner_inner_inner_inner = model.NewIntVar(1, 16, 'dense_wmma_accumulator_j_c_inner_inner_inner_inner')
...
model.AddMultiplicationEquality(16, [dense_j_outer, dense_j_inner])

...
C_j_outer = model.NewIntVar(1, 14368, 'C_j_outer')
C_j_inner = model.NewIntVar(1, 14368, 'C_j_inner')
...
Cj_innertileSpatial = model.NewIntVar(1, 14368, 'Cj_innertileSpatial')
C_j_inner_outer = model.NewIntVar(1, 14368, 'C_j_inner_outer')
C_j_inner_inner = model.NewIntVar(1, 14368, 'C_j_inner_inner')
...
Cj_inner_innertileSpatial = model.NewIntVar(1, 14368, 'Cj_inner_innertileSpatial')
C_j_inner_inner_outer = model.NewIntVar(1, 14368, 'C_j_inner_inner_outer')
C_j_inner_inner_inner = model.NewIntVar(1, 14368, 'C_j_inner_inner_inner')
...
Cj_inner_inner_innertileSpatial = model.NewIntVar(1, 14368, 'Cj_inner_inner_innertileSpatial')
C_j_inner_inner_inner_outer = model.NewIntVar(1, 14368, 'C_j_inner_inner_inner_outer')
C_j_inner_inner_inner_inner = model.NewIntVar(1, 14368, 'C_j_inner_inner_inner_inner')
...
Cj_inner_inner_inner_innertileSpatial = model.NewIntVar(1, 14368, 'Cj_inner_inner_inner_innertileSpatial')
C_j_inner_inner_inner_inner_outer = model.NewIntVar(1, 14368, 'C_j_inner_inner_inner_inner_outer')
C_j_inner_inner_inner_inner_inner = model.NewIntVar(1, 14368, 'C_j_inner_inner_inner_inner_inner')
...
C_wmma_accumulator_shared_ax1 = model.NewIntVar(1, 14368, 'C_wmma_accumulator_shared_ax1')
...
C_wmma_accumulator_sharedax1tileSpatial = model.NewIntVar(1, 14368, 'C_wmma_accumulator_sharedax1tileSpatial')
C_wmma_accumulator_shared_ax1_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_shared_ax1_outer')
C_wmma_accumulator_shared_ax1_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_shared_ax1_inner')
...
C_wmma_accumulator_shared_ax1_inner_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_shared_ax1_inner_outer')
C_wmma_accumulator_shared_ax1_inner_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_shared_ax1_inner_inner')
...
C_wmma_accumulator_j_c = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c')
...
C_wmma_accumulatorj_ctileAll = model.NewIntVar(1, 14368, 'C_wmma_accumulatorj_ctileAll')
C_wmma_accumulator_j_c_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_outer')
C_wmma_accumulator_j_c_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner')
...
C_wmma_accumulatorj_c_innertileAll = model.NewIntVar(1, 14368, 'C_wmma_accumulatorj_c_innertileAll')
C_wmma_accumulator_j_c_inner_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_outer')
C_wmma_accumulator_j_c_inner_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_inner')
...
C_wmma_accumulatorj_c_inner_innertileAll = model.NewIntVar(1, 14368, 'C_wmma_accumulatorj_c_inner_innertileAll')
C_wmma_accumulator_j_c_inner_inner_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_inner_outer')
C_wmma_accumulator_j_c_inner_inner_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_inner_inner')
...
C_wmma_accumulator_j_c_inner_inner_inner_outer = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_inner_inner_outer')
C_wmma_accumulator_j_c_inner_inner_inner_inner = model.NewIntVar(1, 14368, 'C_wmma_accumulator_j_c_inner_inner_inner_inner')
...
A_shared_wmma_matrix_b_ax0 = model.NewIntVar(1, 14368, 'A_shared_wmma_matrix_b_ax0')
...
A_shared_wmma_matrix_b_ax0_outer = model.NewIntVar(1, 14368, 'A_shared_wmma_matrix_b_ax0_outer')
A_shared_wmma_matrix_b_ax0_inner = model.NewIntVar(1, 14368, 'A_shared_wmma_matrix_b_ax0_inner')
...
A_shared_ax0 = model.NewIntVar(1, 14368, 'A_shared_ax0')
A_shared_tmp_ax0 = model.NewIntVar(1, 14368, 'A_shared_tmp_ax0')
...
model.AddMultiplicationEquality(14368, [C_j_outer, C_j_inner])

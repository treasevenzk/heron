...
model.AddMultiplicationEquality(dense_i, [dense_i_outer, dense_i_inner])
model.Add(dense_i_outer == 1)
model.AddMultiplicationEquality(dense_j, [dense_j_outer, dense_j_inner])
model.Add(dense_j_outer == 1)
model.AddMultiplicationEquality(dense_i_inner, [dense_i_inner_outer, dense_i_inner_inner])
model.Add(dense_i_inner_outer == dense_tileSpatial)
model.AddMultiplicationEquality(dense_j_inner, [dense_j_inner_outer, dense_j_inner_inner])
model.Add(dense_j_inner_outer == dense_tileSpatial)
model.AddMultiplicationEquality(blockIdx_x, [dense_tileSpatial, dense_tileSpatial])
...
model.Add(dense_i_inner_inner_outer == dense_tileSpatial)
model.AddMultiplicationEquality(dense_j_inner_inner, [dense_j_inner_inner_outer, dense_j_inner_inner_inner])
model.Add(dense_j_inner_inner_outer == dense_tileSpatial)
model.AddMultiplicationEquality(threadIdx_y, [dense_tileSpatial, dense_tileSpatial])
...
model.Add(dense_i_inner_inner_inner_outer == dense_tileSpatial)
...
model.Add(dense_j_inner_inner_inner_outer == dense_tileSpatial)
model.AddMultiplicationEquality(threadIdx_x, [dense_tileSpatial, dense_tileSpatial])
...
model.Add(dense_i_inner_inner_inner_inner_outer == dense_tileSpatial)
...
model.Add(dense_j_inner_inner_inner_inner_outer == dense_tileSpatial)
...
model.Add(dense_wmma_accumulator_shared_ax0_outer == dense_wmma_accumulator_shared_tileSpatial)
...
model.Add(dense_wmma_accumulator_shared_ax1_outer == dense_wmma_accumulator_shared_tileSpatial)
model.AddMultiplicationEquality(threadIdx_y, [dense_wmma_accumulator_shared_tileSpatial, dense_wmma_accumulator_shared_tileSpatial])
...
model.Add(dense_wmma_accumulator_i_c_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_outer == dense_wmma_accumulator_tileAll)
model.AddMultiplicationEquality(dense_wmma_accumulator_k, [dense_wmma_accumulator_k_outer, dense_wmma_accumulator_k_inner])
model.Add(dense_wmma_accumulator_k_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_i_c_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_k_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_i_c_inner_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_inner_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(dense_wmma_accumulator_k_inner_inner_outer == dense_wmma_accumulator_tileAll)
...
model.Add(B_shared_ax0_tmp == dense_wmma_accumulator_j_c_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(dense_wmma_accumulator_shared_pos == 0).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(B_shared_ax0_tmp == dense_wmma_accumulator_j_c_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(dense_wmma_accumulator_shared_pos == 1).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(B_shared_ax0_tmp == dense_wmma_accumulator_j_c_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(dense_wmma_accumulator_shared_pos == 2).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(B_shared_ax0_tmp == dense_wmma_accumulator_j_c_inner_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
...
model.AddMultiplicationEquality(B_shared_ax0, [B_shared_ax0_tmp, dense_wmma_accumulator_shared_tileSpatial])
...
model.Add(A_shared_ax0_tmp == dense_wmma_accumulator_i_c_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(dense_wmma_accumulator_shared_pos == 0).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(A_shared_ax0_tmp == dense_wmma_accumulator_i_c_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(dense_wmma_accumulator_shared_pos == 1).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(A_shared_ax0_tmp == dense_wmma_accumulator_i_c_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(dense_wmma_accumulator_shared_pos == 2).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(A_shared_ax0_tmp == dense_wmma_accumulator_i_c_inner_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
model.Add(dense_wmma_accumulator_shared_pos == 3).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
model.Add(sum([dense_wmma_accumulator_shared_pos_select0, dense_wmma_accumulator_shared_pos_select1, dense_wmma_accumulator_shared_pos_select2, dense_wmma_accumulator_shared_pos_select3]) == 1)
model.AddMultiplicationEquality(A_shared_ax0, [A_shared_ax0_tmp, dense_wmma_accumulator_shared_tileSpatial])

...
densei_inner_tileSpatial = model.NewIntVar(1, 64, 'densei_inner_tileSpatial')
dense_i_inner_outer = model.NewIntVar(1, 64, 'dense_i_inner_outer')
dense_i_inner_inner = model.NewIntVar(1, 64, 'dense_i_inner_inner')
densej_inner_tileSpatial = model.NewIntVar(1, 64, 'densej_inner_tileSpatial')
...
densei_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densei_inner_inner_tileSpatial')
...
densej_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densej_inner_inner_tileSpatial')
...
densei_inner_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densei_inner_inner_inner_tileSpatial')
...
densej_inner_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densej_inner_inner_inner_tileSpatial')
...
densei_inner_inner_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densei_inner_inner_inner_inner_tileSpatial')
...
densej_inner_inner_inner_inner_tileSpatial = model.NewIntVar(1, 64, 'densej_inner_inner_inner_inner_tileSpatial')
...
dense_wmma_accumulator_sharedax0_tileSpatial = model.NewIntVar(1, 64, 'dense_wmma_accumulator_sharedax0_tileSpatial')
...
dense_wmma_accumulator_sharedax1_tileSpatial = model.NewIntVar(1, 64, 'dense_wmma_accumulator_sharedax1_tileSpatial')
...
dense_wmma_accumulatori_c_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatori_c_tileAll')
...
dense_wmma_accumulatorj_c_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatorj_c_tileAll')
...
dense_wmma_accumulatork_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatork_tileAll')
...
dense_wmma_accumulatori_c_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatori_c_inner_tileAll')
...
dense_wmma_accumulatorj_c_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatorj_c_inner_tileAll')
...
dense_wmma_accumulatork_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatork_inner_tileAll')
...
dense_wmma_accumulatori_c_inner_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatori_c_inner_inner_tileAll')
...
dense_wmma_accumulatorj_c_inner_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatorj_c_inner_inner_tileAll')
...
dense_wmma_accumulatork_inner_inner_tileAll = model.NewIntVar(1, 64, 'dense_wmma_accumulatork_inner_inner_tileAll')
...
B_shared_tmpax0 = model.NewIntVar(1, 64, 'B_shared_tmpax0')
...
A_shared_tmpax0 = model.NewIntVar(1, 64, 'A_shared_tmpax0')
...
model.Add(dense_i_inner_outer == densei_inner_tileSpatial)
model.AddMultiplicationEquality(dense_j_inner, [dense_j_inner_outer, dense_j_inner_inner])
model.Add(dense_j_inner_outer == densej_inner_tileSpatial)
model.AddMultiplicationEquality(blockIdx_x, [densei_inner_tileSpatial, densej_inner_tileSpatial])
...
model.Add(dense_i_inner_inner_outer == densei_inner_inner_tileSpatial)
model.AddMultiplicationEquality(dense_j_inner_inner, [dense_j_inner_inner_outer, dense_j_inner_inner_inner])
model.Add(dense_j_inner_inner_outer == densej_inner_inner_tileSpatial)
model.AddMultiplicationEquality(threadIdx_y, [densei_inner_inner_tileSpatial, densej_inner_inner_tileSpatial])
...
model.Add(dense_i_inner_inner_inner_outer == densei_inner_inner_inner_tileSpatial)
...
model.Add(dense_j_inner_inner_inner_outer == densej_inner_inner_inner_tileSpatial)
model.AddMultiplicationEquality(threadIdx_x, [densei_inner_inner_inner_tileSpatial, densej_inner_inner_inner_tileSpatial])
...
model.Add(dense_i_inner_inner_inner_inner_outer == densei_inner_inner_inner_inner_tileSpatial)
...
model.Add(dense_j_inner_inner_inner_inner_outer == densej_inner_inner_inner_inner_tileSpatial)
...
model.Add(dense_wmma_accumulator_shared_ax0_outer == dense_wmma_accumulator_sharedax0_tileSpatial)
...
model.Add(dense_wmma_accumulator_shared_ax1_outer == dense_wmma_accumulator_sharedax1_tileSpatial)
model.AddMultiplicationEquality(threadIdx_y, [dense_wmma_accumulator_sharedax0_tileSpatial, dense_wmma_accumulator_sharedax1_tileSpatial])
...
model.Add(dense_wmma_accumulator_i_c_outer == dense_wmma_accumulatori_c_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_outer == dense_wmma_accumulatorj_c_tileAll)
model.AddMultiplicationEquality(64, [dense_wmma_accumulator_k_outer, dense_wmma_accumulator_k_inner])
model.Add(dense_wmma_accumulator_k_outer == dense_wmma_accumulatork_tileAll)
...
model.Add(dense_wmma_accumulator_i_c_inner_outer == dense_wmma_accumulatori_c_inner_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_inner_outer == dense_wmma_accumulatorj_c_inner_tileAll)
...
model.Add(dense_wmma_accumulator_k_inner_outer == dense_wmma_accumulatork_inner_tileAll)
...
model.Add(dense_wmma_accumulator_i_c_inner_inner_outer == dense_wmma_accumulatori_c_inner_inner_tileAll)
...
model.Add(dense_wmma_accumulator_j_c_inner_inner_outer == dense_wmma_accumulatorj_c_inner_inner_tileAll)
...
model.Add(dense_wmma_accumulator_k_inner_inner_outer == dense_wmma_accumulatork_inner_inner_tileAll)
...
model.Add(B_shared_tmpax0 == dense_wmma_accumulator_j_c_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(dense_wmma_accumulator_shared_pos == 0).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(B_shared_tmpax0 == dense_wmma_accumulator_j_c_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(dense_wmma_accumulator_shared_pos == 1).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(B_shared_tmpax0 == dense_wmma_accumulator_j_c_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(dense_wmma_accumulator_shared_pos == 2).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(B_shared_tmpax0 == dense_wmma_accumulator_j_c_inner_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
...
model.AddMultiplicationEquality(B_shared_ax0, [B_shared_tmpax0, dense_wmma_accumulator_sharedax1_tileSpatial])
...
model.Add(A_shared_tmpax0 == dense_wmma_accumulator_i_c_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(dense_wmma_accumulator_shared_pos == 0).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select0)
model.Add(A_shared_tmpax0 == dense_wmma_accumulator_i_c_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(dense_wmma_accumulator_shared_pos == 1).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select1)
model.Add(A_shared_tmpax0 == dense_wmma_accumulator_i_c_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(dense_wmma_accumulator_shared_pos == 2).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select2)
model.Add(A_shared_tmpax0 == dense_wmma_accumulator_i_c_inner_inner_inner_inner).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
model.Add(dense_wmma_accumulator_shared_pos == 3).OnlyEnforceIf(dense_wmma_accumulator_shared_pos_select3)
model.Add(sum([dense_wmma_accumulator_shared_pos_select0, dense_wmma_accumulator_shared_pos_select1, dense_wmma_accumulator_shared_pos_select2, dense_wmma_accumulator_shared_pos_select3]) == 1)
model.AddMultiplicationEquality(A_shared_ax0, [A_shared_tmpax0, dense_wmma_accumulator_sharedax0_tileSpatial])
